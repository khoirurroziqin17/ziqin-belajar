...
export default function K13Page(): React.ReactElement {
  return (
    <main className="container flex flex-col items-center py-16 text-center">
      ...
      <p className="max-w-3xl text-muted-foreground">
        Kurikulum 2013 bertujuan untuk meningkatkan kualitas pendidikan dengan
        memperkenalkan pendekatan pembelajaran yang lebih kontekstual, holistik,
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 text-left md:grid-cols-2">
        {kelas.map((k) => (
          <Item key={k.kelas} href={`/buku/k13/${k.kelas}/ipa`}>
